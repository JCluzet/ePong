...
export default function Chat () {
    ...
    return (
        <div >
            ...
            <Row>
                <Col span={20}>
                    <ChatFeed userName={userName} currentChannelId={currentChannelId} setCurrentChannelId={setCurrentChannelId} />
                </Col>
                <Col span={4}>
                    <SideBar userName={userName} currentChannelId={currentChannelId} setCurrentChannelId={setCurrentChannelId} />
                </Col>
            </Row>
        </div>
    )
